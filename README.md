...
<p align="center">
  <img src="https://raw.githubusercontent.com/Dev-zakaria-Dev/Dev-zakaria-Dev/main/fang_yuan.jpg" alt="Fang Yuan - Perseverance" width="100%" style="max-height: 380px; object-fit: cover; border-radius: 8px; border: 2px solid #00FF66;" />
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Inertia.js-9553E6?style=for-the-badge&logo=inertia&logoColor=white" />
...
```mermaid
graph LR
    A[Raw Source Code] -->|Perseverance Gu| B(Automated Refinement)
    B --> C{Optimization Test}
    C -->|Pass| D[Deploy Production Monolith]
    C -->|Fail| E[Isolate Aperture Flaws / Debug]
    style A fill:#0d1117,stroke:#00FF66,stroke-width:2px,color:#fff
    style B fill:#0d1117,stroke:#00FF66,stroke-width:2px,color:#fff
